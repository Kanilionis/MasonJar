...
const LoginButton = () => {
  ...
  return(
       ...
       */}
  <center>   
  <svg onClick={() => loginWithRedirect()} className="login-btn" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" height="100px" viewBox="0 0 53.608 30.729" enableBackground="new 0 0 53.608 30.729" space="preserve">
  ...
  <rect y="7.636" width="53.608" height="15.276"/><text fontSize="10px" id="login-jar" x="50%" y="59%" textAnchor="middle" fill="white">LOG IN</text>
  </svg>
  </center> 
    </>
  )
