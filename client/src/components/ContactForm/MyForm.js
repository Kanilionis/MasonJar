      ...
      <>
        <h2 className="h2-text">Contact Us</h2>
          ...
          >
            ...
            <div className="form-group">
              {status === "SUCCESS" ? <p className="success">Thanks!</p> : <button className="contactBtn"><svg  className="submit-btn" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" height="50"
        ...
        <rect y="7.636" width="53.608" height="15.276"/><text fontSize="10px" id="login-jar" x="50%" y="56%" textAnchor="middle" fill="white">submit</text>
              ...
              {status === "ERROR" && <p className="success">Ooops! There was an error.</p>}
            </div>
          </form>
      </>
    );
